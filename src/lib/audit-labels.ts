...
export const AUDIT_ACTION_LABELS: Readonly<Record<string, string>> = {
  ...
  'customers.created': 'Cadastrou cliente',
  'customers.updated': 'Alterou cadastro de cliente',
  'customers.exported': 'Exportou planilha de clientes',
  'reports.exported': 'Exportou relatório',
  'marketing.settings_updated': 'Alterou pixels de marketing',
  ...
  'calendar.special_prices_updated': 'Alterou preços especiais de um dia',
